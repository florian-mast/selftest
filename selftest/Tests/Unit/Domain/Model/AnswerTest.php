...
/**
 * Test case for class \TYPO3\Selftest\Domain\Model\Answer.
 *
 * @version $Id$
...
class AnswerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \TYPO3\Selftest\Domain\Model\Answer
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\Selftest\Domain\Model\Answer();
	}
	...
	public function setStatementForStringSetsStatement() { 
		$this->fixture->setStatement('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getStatement()
		);
	}
